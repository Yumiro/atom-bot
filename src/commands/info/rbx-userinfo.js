        ...
        rbx.getIdFromUsername(username).then(id => {
            if (id) {
                rbx.getPlayerInfo(parseInt(id)).then(function(info) {
                    ...
                    .addField('Blurb', info.blurb || 'No blurb available', true)
                    .addField('Status', info.status || 'No status available', true)
...
exports.help = {
    ...
    name: 'rbx-userinfo',
    category: '❔ Info',
    description: 'Sends information about a specified Roblox user',
